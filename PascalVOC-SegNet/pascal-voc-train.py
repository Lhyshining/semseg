...
caffe_root = '/home/yubao/data/Project/semseg/caffe/'  # this file is expected to be in {caffe_root}/examples
sys.path.append(caffe_root + 'python')
sys.path.append(caffe_root + 'examples')
...
pascal_root = osp.join(caffe_root, '/home/yubao/data/Dataset/VOC/VOC2012')
